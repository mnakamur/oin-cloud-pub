  ...
  <div style="height: 100%; width: 100%">
    ...
    >
      <div class="absolute right-0 bottom-0 mr-4 mb-4 flex">
        <div style="position: absolute; left: 0px; bottom: -30px; margin: 4 auto auto 4">
          <button v-if="drawStatus == 'draw'" @click="cancel" class="pm-button">消</button>
          <button v-if="drawStatus == 'draw'" @click="finish" class="pm-button">完</button>
        </div>
      </div>
