...
<template>
	...
	<div>
		...
		<form @submit.prevent="updateUserProfile">
			<div>
				<label class="stlabel" for="createUser_name">{{$t('名前')}}:</label>
				<input
					class="stinput"
					type="text"
					id="createUser_name"
			...
			<div>
				<label class="stlabel" for="company_name">{{$t('会社名')}}:</label>
				<input
					class="stinput"
					type="text"
					id="company_name"
					v-model="attributes.companyName"
				/>
			</div>

			<div>
				<label class="stlabel" for="department">{{$t('部署名')}}:</label>
				<input
					class="stinput"
					type="text"
					id="department"
			...
			<div>
				<label class="stlabel" for="post">{{$t('役職名')}}:</label>
				<input
					class="stinput"
					type="text"
					id="post"
					v-model="attributes.post"
				/>
			</div>
			<div>
				<label class="stlabel" for="phone_number">{{$t('電話番号')}}:</label>
				<input
					class="stinput"
					type="text"
					id="phone_number"
					v-model="attributes.phoneNumber"
				/>
			</div>

			<button class="button-class" type="submit">{{$t('更新')}}</button>
		</form>
		<div
			v-if="infoVisible"
